...
This folder is the first topic branch for notes about how LLMs work.
...
| **001-005** | [LLM Single Facts](./001-005-llm-single-facts.md) | Short independent facts about LLM internals. |
...
When referring to a page in chat, use the page number, for example: 001-002
