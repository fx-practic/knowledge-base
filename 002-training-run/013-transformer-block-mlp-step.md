Path: 002-training-run/013-transformer-block-mlp-step.md
...
reshapes the features inside each token row. It is like per-token internal
thinking, while attention is token-to-token communication.
